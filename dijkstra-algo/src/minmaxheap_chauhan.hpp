...
private:
    ...
    void minheapify(int index) {
        ...
        smallestNumber = (leftSide <= heapSize && heapArray[leftSide] < heapArray[smallestNumber]) ? leftSide
                                                                                                   : smallestNumber;

        // if right side is less than the size and the data at right side is less than the data at smallest number
        smallestNumber = (rightSide <= heapSize && heapArray[rightSide] < heapArray[smallestNumber]) ? rightSide
                                                                                                     : smallestNumber;
